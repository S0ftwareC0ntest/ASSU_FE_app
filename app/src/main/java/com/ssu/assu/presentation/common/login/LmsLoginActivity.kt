...
class LmsLoginActivity : BaseActivity<ActivityLmsLoginBinding>(R.layout.activity_lms_login) {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // WebView 첫 로드 전 내부 서페이스가 검게 보이는 현상 완화
        webView.setBackgroundColor(ContextCompat.getColor(this, R.color.assu_background))
        ...
        loginViewModel.loginState.observe(this) { state ->
            when (state) {
                ...
                is LoginState.Loading -> {
                    showLoading(getString(R.string.lms_loading_message))
